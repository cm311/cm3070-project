...
def demonstrate_all(start='2022-08-11'):
    ...
    for arts in arts_fr:
        ...
        fr_data['word2vec'].append(nlp.related_from_word2vec('inde', pipe, language='fr'))
        fr_data['FastText'].append(nlp.related_from_fasttext('inde', pipe, language='fr'))
    ...
    dates = ['Aug 11', 'Aug 12', 'Aug 13', 'Aug 14', 'Aug 15', 'Aug 16', 'Aug 17', 'Aug 18']
